...
#include <vector>
#include <string>
#include "../main/Factory/idcard/IDCardFactory.h"
#include "../main/Factory/idcard/IDCard.h"
#include "../main/Factory/framework/Product.h"
#include "../main/Factory/framework/Factory.h"
